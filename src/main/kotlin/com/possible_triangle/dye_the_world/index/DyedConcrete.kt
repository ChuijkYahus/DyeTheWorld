...
object DyedConcrete {
    ...
    val CONCRETE_SLABS = REGISTRATE.createSlabs(CONCRETE, MORE_CONCRETE.createId("concrete"), modifyBlock = { dye ->
        germanLang("${dye.germanTranslation(Genus.F)} Betonstufe")
    })

    val CONCRETE_STAIRS = REGISTRATE.createStairs(CONCRETE, MORE_CONCRETE.createId("concrete"), modifyBlock = { dye ->
        germanLang("${dye.germanTranslation(Genus.F)} Betontreppe")
    })

    val CONCRETE_WALLS = REGISTRATE.createWalls(CONCRETE, MORE_CONCRETE.createId("concrete"), modifyBlock = { dye ->
        germanLang("${dye.germanTranslation(Genus.F)} Betonmaur")
    })

    val CONCRETE_FENCES = REGISTRATE.createFences(CONCRETE, MORE_CONCRETE.createId("concrete"), modifyBlock = { dye ->
        germanLang("${dye.germanTranslation(Genus.M)} Betonzaun")
        optionalTag(BlockTags.MINEABLE_WITH_PICKAXE)
    })

    val CONCRETE_FENCE_GATES = REGISTRATE.createFenceGates(CONCRETE, MORE_CONCRETE.createId("concrete"), modifyBlock = { dye ->
        germanLang("${dye.germanTranslation(Genus.M)} Betonzauntor")
        optionalTag(BlockTags.MINEABLE_WITH_PICKAXE)
    })

    val CONCRETE_BUTTONS = REGISTRATE.createButtons(CONCRETE, MORE_CONCRETE.createId("concrete"), modifyBlock = { dye ->
        germanLang("${dye.germanTranslation(Genus.M)} Betonknopf")
        optionalTag(BlockTags.MINEABLE_WITH_PICKAXE)
    })

    val CONCRETE_LEVERS = REGISTRATE.createLevers(CONCRETE, MORE_CONCRETE.createId("concrete"), modifyBlock = { dye ->
        germanLang("${dye.germanTranslation(Genus.M)} Betonhebel")
        optionalTag(BlockTags.MINEABLE_WITH_PICKAXE)
    })

    val CONCRETE_PRESSURE_PLATES = REGISTRATE.createPressurePlates(CONCRETE, MORE_CONCRETE.createId("concrete"), modifyBlock = { dye ->
