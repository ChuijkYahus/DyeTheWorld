...
fun <T : Item, P> ItemBuilder<T, P>.tableClothItemModel(dye: DyeColor) = model { context, provider ->
...
fun <T : TableClothBlock, P> BlockBuilder<T, P>.tableClothBlockstate(dye: DyeColor) = blockstate { context, provider ->
...
fun <T : Item, P> ItemBuilder<T, P>.tableClothRecipe(dye: DyeColor) = recipe(CREATE) { context, provider ->
