...
fun KotlinRegistrate.generateDyeTags() {
    ...
    DyeColor.entries.forEach { dye ->
        DyedTags.HAMMOCKS.addOptional(Mods.COMFORTS.createId("hammock_$dye"))
        DyedTags.SLEEPING_BAGS.addOptional(Mods.COMFORTS.createId("sleeping_bag_$dye"))
    }
}